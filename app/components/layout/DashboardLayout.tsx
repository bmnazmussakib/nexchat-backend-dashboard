            ...
            <div className="drawer lg:drawer-open">
                ...
                <div className="drawer-content">
                    ...
                    <nav className="navbar w-full bg-stone-50 p-5">
                        <label htmlFor="my-drawer-4" aria-label="open sidebar" className="btn btn-square btn-ghost hidden">
                            {/* Sidebar toggle icon */}
                ...
                <div className="drawer-side is-drawer-close:overflow-visible">
                    ...
                    <div className="flex min-h-full flex-col items-start bg-stone-50 is-drawer-close:w-14 is-drawer-open:w-64">
                        <div className='p-5 border-b border-stone-200 w-full'>
                            <img src="/assets/images/logo.png" alt="" />
                        </div>
                        {/* Sidebar content here */}
                        <ul className="menu w-full grow font-grandis">
                            {/* List item */}
                            <li>
