                ...
                <div className="drawer-content">
                    ...
                    <nav className="navbar w-full h-20 bg-stone-50 px-5 border-b border-stone-200">
                        ...
                        <div className="flex w-full items-center justify-between">
                            <div>
                                <h2 className='font-grandis lg:text-3xl md:text-2xl text-xl font-bold text-[#343C6A]'>Overview</h2>
                                <p className='font-grandis lg:text-[15px] md:text-sm text-xs font-normal text-[#B1B1B1]'>Welcome to Your AI Agent Dashboard</p>
                            </div>
                            <div className='flex lg:gap-6'>
                                <div className="dropdown dropdown-end">
                                    <div tabIndex={0} role="button" className="btn bg-[#F5F7FA] m-1 md:w-12 md:h-12 w-8 h-8 p-2 rounded-full border-0 shadow-none">
                                ...
                                <div className="dropdown dropdown-end">
                                    <div tabIndex={0} role="button" className="m-1">
                                        <div className="avatar">
                                            <div className="lg:w-12 w-8 rounded-full">
